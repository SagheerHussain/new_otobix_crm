    ...
    return (
      ...
      `}>
                    ...
                    {menuItems.map((item) => (
                        item.comingSoon ? (
                            ...
                            >
                                ...
                                <span className="text-[8px] font-black uppercase tracking-widest bg-white/10 px-1 py-0.5 rounded">Soon</span>
                            </div>
                        ) : (
                            <NavLink
                                key={item.name}
                ...
                <div className="p-4 border-t border-slate-800 relative">
                    ...
                    >
                        <div className="w-10 h-10 rounded-full bg-cover bg-center ring-2 ring-primary/30 group-hover:ring-primary transition-all" style={{ backgroundImage: `url(${amitProfile})` }}></div>
                        <div className="flex-1 text-left">
                            <h4 className="text-sm font-semibold text-white">Amit Parekh</h4>
